...
rmsetrain_trf = np.genfromtxt('./targettrftrainrmse.csv')
rmsetest_trf = np.genfromtxt('./targettrftestrmse.csv')
...
rmsetrain = np.genfromtxt('./targettrainrmse.csv')
rmsetest = np.genfromtxt('./targettestrmse.csv')
